# Manual Setup Steps for Minions Contacts
...
Go to **GitHub → mxn2020/minions-contacts → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-contacts` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-contacts-web`
- **GitHub repo**: `mxn2020/minions-contacts`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `contacts.minions.wtf`

### Documentation
- **Netlify site name**: `minions-contacts-docs`
- **GitHub repo**: `mxn2020/minions-contacts`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `contacts.minions.help`

### Blog
- **Netlify site name**: `minions-contacts-blog`
- **GitHub repo**: `mxn2020/minions-contacts`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `contacts.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `contacts.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `contacts.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `contacts.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-contacts/sdk`](https://www.npmjs.com/package/@minions-contacts/sdk)
- CLI: [`@minions-contacts/cli`](https://www.npmjs.com/package/@minions-contacts/cli)
...
Your package: [`minions-contacts`](https://pypi.org/project/minions-contacts/)
...
| Item | Value |
|------|-------|
| Project | `minions-contacts` |
| SDK (npm) | `@minions-contacts/sdk` |
| CLI (npm) | `@minions-contacts/cli` |
| Python (PyPI) | `minions-contacts` |
| GitHub | `github.com/mxn2020/minions-contacts` |
| Docs domain | `contacts.minions.help` |
| Blog domain | `contacts.minions.blog` |
| App domain | `contacts.minions.wtf` |
