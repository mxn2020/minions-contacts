...
/**
 * @minions-contacts/cli — CLI for Minions contacts
 *
...
import { customTypes } from '@minions-contacts/sdk';
...
program.name('contacts').description('People, organizations, and contact channels').version('0.1.0');

program.command('info').description('Show project info').action(() => {
    console.log(chalk.bold('Minions contacts'));
    console.log(chalk.dim('People, organizations, and contact channels'));
    console.log('');
    console.log(`  SDK:    ${chalk.cyan('@minions-contacts/sdk')}`);
    console.log(`  CLI:    ${chalk.cyan('@minions-contacts/cli')}`);
    console.log(`  Python: ${chalk.cyan('minions_contacts')}`);
